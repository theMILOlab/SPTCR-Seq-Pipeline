...
parser.add_argument('-b', '--INPUT_IGB', help="Path to IgBlast Tsv. Use Full IgBlast Output from PreProcessed Reads",required=True)
...
parser.add_argument('-grp', '--GROUPER', help="Grouper to be used by TCR_GROUPING_IGB.py for grouping the TCR Reads into Fastqs. Pick one or a combination of: locus,v_family, d_family, j_family",default="locus,v_family")

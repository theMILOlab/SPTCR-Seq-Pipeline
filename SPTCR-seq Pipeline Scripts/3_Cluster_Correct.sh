...
parser.add_argument('-bars', '--BARCODES', help="Path to .tsv holding barcodes under Tissue, defaults to: ./Reference/Barcodes/visium_bc.tsv",default="all_visium")
